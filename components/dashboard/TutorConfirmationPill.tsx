...
export function TutorConfirmationPill({
  ...
  return (
    <div className="pointer-events-none fixed left-1/2 top-4 z-[110] -translate-x-1/2">
      <div
        className={`rounded-full border border-[#bbf7d0] bg-[#ecfdf3] px-4 py-2 text-[0.78rem] font-semibold text-[#166534] shadow-[0_8px_24px_rgba(22,101,52,0.18)] transition-all duration-300 ${
