...
export function SetupSuccessView({ dashboardHref = "/students/dashboard" }: { dashboardHref?: string }) {
  return (
    <section className="mx-auto flex h-full w-full max-w-[51.25rem] items-center justify-center px-4 py-8 sm:px-8">
      <div className="text-center">
        <div className="mx-auto mb-5 w-fit">
          <SuccessBadgeIcon />
        </div>
        <h1 className="text-3xl font-bold tracking-[-0.02em] text-[#1d2331] sm:text-4xl">You&apos;re good to go.</h1>
