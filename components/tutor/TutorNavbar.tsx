...
import { BookOpen, CalendarDays, ChevronDown, CreditCard, Home, Menu, MessageCircle, X } from "lucide-react";
    ...
    <header className="dashboard-header z-50 border-b border-[#ECEFF5] bg-white shadow-[0_1px_8px_rgba(31,40,74,0.05)]">
      <div className="grid min-h-[var(--topbar-h)] w-full grid-cols-[auto_1fr_auto] items-center gap-[0.9em] px-[1em] py-0">
        ...
        <div className="ml-auto flex items-center justify-end gap-[0.52em]">
          ...
          <button className="hidden items-center gap-[0.38em] rounded-full border border-[#E6E8EF] bg-[#F2F3F7] px-[0.4em] py-[0.24em] xl:flex">
            ...
            <div className="text-left leading-tight">
              <p className="text-[0.68em] font-semibold text-[#303755]">Oluyinka Alabi</p>
              <p className="text-[0.58em] text-[#7f879d]">Oluyinka@gmail.com</p>
            </div>
        ...
        <div className="fixed inset-0 z-[70] xl:hidden">
          ...
          <div className={`absolute right-0 top-0 h-full w-[min(82vw,21em)] border-l border-[#e6eaf3] bg-white p-[1em] shadow-2xl transition-transform duration-200 ${isMenuOpen ? "translate-x-0" : "translate-x-full"}`}>
            <div className="mb-[1em] flex items-center justify-between">
              <p className="text-[0.9em] font-semibold text-[#4a5166]">Tutor menu</p>
              <button
            ...
            <button
              className="mt-[0.85em] w-full rounded-[0.55em] border border-[#d8daf8] bg-[#eef0ff] px-[0.9em] py-[0.65em] text-left text-[0.82em] font-semibold text-[#4A46D6]"
              onClick={() => {
                closeMenu();
      ...
      {isStudentModalOpen ? (
        <div className="fixed inset-0 z-[80] flex items-center justify-center bg-[#0f1530]/35 px-4">
          <div className="w-full max-w-[27rem] rounded-2xl border border-[#e6eaf3] bg-white p-5 shadow-2xl">
            <h3 className="text-[1rem] font-semibold text-[#2f3547]">Switch to student dashboard?</h3>
            <p className="mt-2 text-[0.82rem] leading-relaxed text-[#69728b]">
              You are about to switch from tutor view to student view. Do you want to continue?
            </p>
