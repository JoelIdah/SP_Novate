...
import { ArrowLeft, BanknoteArrowDown, Check, CheckCircle2, Copy, EllipsisVertical, Search, SlidersHorizontal, Wallet } from "lucide-react";
  ...
  return (
    <main className="dashboard-screen bg-white text-[#2b3245]">
      <div className="dashboard-shell">
        <TutorNavbar active="Transactions" />
